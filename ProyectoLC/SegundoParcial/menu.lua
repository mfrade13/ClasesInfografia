...
function scene:create( event )
	...
	local titleLogo = display.newText( "Disc War", 264, 42 ,native.systemFontBold,80)
	titleLogo.x = display.contentCenterX
	titleLogo.y = 100
	
	-- create/position logo/title image on upper-half of the screen
	local singnature = display.newText( "by: Choquesin", 264, 42 ,native.systemFont,20)
	singnature:setFillColor( 1,0,0 )
